...
public:
    ...
    std::vector<BossProjectile *> *getBossProjectiles();
    ...
    void getEnemyTexturePoses(int basic, int speed, int shooting, int bossLife, int boss2Life);
...
private:
    ...
    int boss2LifeShouldBeKilled;
    vec2 boss2LifeTexturePos;
    int numCurrents;
    ...
    std::vector<CastleTop *> castleTops;
    ...
    DefaultTexture boss2LifeTexture;
    DefaultTexture boss2LifeHeart;
    DefaultTexture boss2LifeX;
    DefaultTexture boss2LifeCounter;
    ...
    void createCastleTops(LevelName level);
